...
<tr valign=top>            
    <td colspan="2">
            ...
            foreach($packages as $package)
            {
                ...
                ?>
                <div title="Click to select your subscription plan."  id="innerDiv_<?php echo($package->uid); ?>"  class='package-box' onclick='packageChanged(this,"<?php echo($package->service_id); ?>;<?php echo($package->billing_routine_id); ?>");'>
...
<tr> 
<td align="left" valign="top"><span id="promo_code_lbl" class="lbl">Enter Discount Code</span></td> 
<td>
...
<tr><td align="left" valign="top"><span id="country_lbl" class="lbl">Cardholder Country</span></td> 
<td>
