...
$customFields = $client->call("GetCustomFields",SubscriptionDNA_wrapAsSoap(array($_SERVER['REMOTE_ADDR'])));
...
<p> 
<table border="0" style="border: 0px solid white;" width="100%"> 
<tr valign=top>
    <td colspan="3"><h3>Subscription Plans:</h3></td>
<tr valign=top>            
    <td colspan="3">
        <div style="border: solid 0px black; padding: 4px; background-color: #ffffff; ">
				<?php 
				$count=0;
...
<tr> 
    <td></td>
    <td colspan="2"><span id="promo_code_lbl_error" class="lblErr"><?php echo($message); ?></span></td> 
</tr> 
...
<td>
<select NAME="country" id="country" class="noErr" size="1" onchange="countryChanged(this.value);"> 
...
<td><span id="country_lbl_error" class="lblErr"></span></td> 
</tr> 
