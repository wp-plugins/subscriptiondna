...
function checkLicenseAgreement(f) {
    if ( !f.agree.checked) {
        ValidateField(false,"agree","Please accept terms & conditions");
    } else {
        ValidateField(true,"agree","Please accept terms & conditions");
    }
}
...
function checkForm(f) {
    ...
    {
        if(document.getElementById("username_validated").value!="1")
         {
             ValidateField(false,"login_name","Login Name already exists");
         }
    }
    ...
    if(checkEmpty("email2","Please re-enter Email."))
    {
      if(document.getElementById("email_validated").value!="1")
       {
           ValidateField(false,"email","Email already exists");
       }
    }
