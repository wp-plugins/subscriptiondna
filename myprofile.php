...
<tr>
    <td>First Name:</td>
    <td><input name="first_name" id="first_name" type="text" value="<?=$profile->first_name; ?>" /> * </td>
</tr>
<tr>
    <td>Last Name:</td>
    <td><input name="last_name" id="last_name" type="text"  value="<?=$profile->last_name; ?>" /> * </td>
</tr>
<tr>
    <td>Email:</td>
    <td><input name="email" id="email" type="text" value="<?=$profile->email; ?>"  /> * </td>
</tr>
<tr>
    <td>Phone:</td>
    <td><input name="phone" id="phone" type="text"  value="<?=$profile->phone; ?>" /></td>
</tr>
<tr>
    <td>Address:</td>
    <td><input name="address1" id="address1" type="text" value="<?=$profile->address1; ?>" /></td>
</tr>
<tr>
    <td>Address 2:</td>
    <td><input name="address2" id="address2" type="text" value="<?=$profile->address2; ?>" /></td>
</tr>

<tr>
    <td>City:</td>
    <td><input name="city" id="city" type="text" value="<?=$profile->city; ?>" /></td>
</tr>
<tr>
    <td>State:</td>
    <td><input name="state" id="state" type="text" value="<?=$profile->state; ?>" /></td>
</tr>
<tr>
    <td>Zip:</td>
    <td><input name="zipcode" id="zipcode" type="text" value="<?=$profile->zipcode; ?>" /></td>
</tr>
<tr>
    <td>Country:</td>
    <td>
								...
								{									
									if($default_value)
									{
										...
										{											
											...
											echo "<input name='".$name."[".$j."]"."' type='".$type."' id='".$name."' ".$selected_val." type='".$type."' value='".$checkbox_list[$j]."' /> ".$checkbox_list[$j]." ";	
										}
										echo("</td>");
									}
									else
									{
										echo "<td><input name='".$name."[".$j."]"."' id='".$name."' type='".$type."' value='".$value."' /></td>";	
									}
								...
								if($type == 'radio')
								{
									if($default_value)
									{
										...
										{											
											...
											echo "<input name='".$name."' type='".$type."' id='".$name."' ".$sel." type='".$type."' value='".$radio_list[$j]."' /> ".$radio_list[$j]."  ";	
										}
										echo("</td>");
									}
									else
									{
										echo "<td><input name='".$name."' id='".$name."' type='".$type."' value='".$value."' /></td>";	
									}
