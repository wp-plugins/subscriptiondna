...
$wsdl =$GLOBALS['SubscriptionDNA']['WSDL_URL'];
	...
	if($_POST['send']){
			...
			$_POST['city'], $_POST['state'], $_POST['zipcode'], $_POST['country'], $cf,$_POST["new_login_name"])));
...
<tr>
    <td>Login Name</td>
    <td><input name="new_login_name" id="new_login_name" type="text" value="<?=$result["login_name"]; ?>" /></td>
</tr>
